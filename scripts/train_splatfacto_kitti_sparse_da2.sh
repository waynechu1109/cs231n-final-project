#!/usr/bin/env bash
# Train splatfacto with DA2 depth supervision on the sparse every-2 KITTI nerfstudio dataset.
set -euo pipefail
...
NERFSTUDIO_SRC="${NERFSTUDIO_SRC:-${PROJECT_ROOT}/data/nerfstudio/kitti_seq02_0034_sparse_every2}"
DATA_DIR="${DATA_DIR:-${PROJECT_ROOT}/data/nerfstudio/kitti_seq02_0034_sparse_every2_da2}"
